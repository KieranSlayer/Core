...
public class DataHandler {
    ...
    private FileConfiguration loadPlayerData(Player player) {
        File file = new File(plugin.getDataFolder(), "Spigot/Commands/Afk/players" + File.separator + player.getUniqueId().toString() + ".yml");
    ...
    public void savePlayer(Player player) {
        try {
            attributedData.get(player).save(new File(plugin.getDataFolder(), "Spigot/Commands/Afk/players"+File.separator+player.getUniqueId().toString()+".yml"));
        } catch(IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public boolean deletePlayer(Player player) {
        unloadPlayer(player);
        return new File(plugin.getDataFolder(), "Spigot/Commands/Afk/players"+File.separator+player.getUniqueId().toString()+".yml").delete();
    }
